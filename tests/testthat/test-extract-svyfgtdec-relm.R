...
# calculate estimates
a1 <- svyfgtdec( ~eqincome , des_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
b1 <- svyfgtdec( ~eqincome , des_eusilc_rep , g = 2 , percent = 0.6 , type_thresh = "relm" )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
d1 <- svyfgt( ~eqincome , des_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" )
d2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 2 , percent = 0.6 , type_thresh = "relm" )
e1 <- svyfgt( ~eqincome , des_eusilc , g = 0 , percent = 0.6 , type_thresh = "relm" )
e2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
f1 <- svyfgt( ~eqincome , des_eusilc , g = 1 , percent = 0.6 , type_thresh = "relm" )
f2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 1 , percent = 0.6 , type_thresh = "relm" )
...
test_that("database svyfgtdec",{
  ...
  # calculate estimates
  c1 <- svyfgtdec( ~eqincome , dbd_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
...
# calculate estimates
sub_des <- svyfgtdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
sub_rep <- svyfgtdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
  sub_dbr <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" )
