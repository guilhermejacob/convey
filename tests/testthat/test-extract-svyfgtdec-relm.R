...
# return test context
context("fgtdec-relm decomposition output survey.design and svyrep.design")
...
# calculate estimates
a1 <- svyfgtdec( ~eqincome , des_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
b1 <- svyfgtdec( ~eqincome , des_eusilc_rep , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
d1 <- svyfgt( ~eqincome , des_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
d2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
e1 <- svyfgt( ~eqincome , des_eusilc , g = 0 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
e2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
f1 <- svyfgt( ~eqincome , des_eusilc , g = 1 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
f2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 1 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
test_that("database svyfgtdec",{
  ...
  # calculate estimates
  c1 <- svyfgtdec( ~eqincome , dbd_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" , influence = TRUE , deff = TRUE )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
# calculate estimates
sub_des <- svyfgtdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
sub_rep <- svyfgtdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE , covmat = TRUE )
  sub_dbr <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , influence = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , deff = TRUE , covmat = TRUE )
