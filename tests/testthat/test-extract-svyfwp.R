...
# calculate estimates
a1 <- svyfwp( ~eqincome , des_eusilc , deff = TRUE )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc, svyfwp , deff = TRUE )
b1 <- svyfwp( ~eqincome , des_eusilc_rep , deff = TRUE )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep, svyfwp , deff = TRUE )
...
test_that("database svyfwp",{
  ...
  # calculate estimates
  c1 <- svyfwp( ~ eqincome , dbd_eusilc , deff = TRUE )
  c2 <- svyby( ~ eqincome , ~hsize , dbd_eusilc , FUN = svyfwp , deff = TRUE )
...
# calculate estimates
sub_des <- svyfwp( ~eqincome , design = subset( des_eusilc , hsize == 1) , deff = TRUE )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyfwp , deff = TRUE )
sub_rep <- svyfwp( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , deff = TRUE )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyfwp , deff = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfwp( ~eqincome , design = subset( des_eusilc , hsize == 1) , deff = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyfwp , deff = TRUE )
  sub_dbr <- svyfwp( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , deff = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyfwp , deff = TRUE )
