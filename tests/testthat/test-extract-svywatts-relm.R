...
# calculate estimates
a1 <- svywatts( ~eqincome , des_eusilc , type_thresh = "relm" , deff = TRUE )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , type_thresh = "relm" , deff = TRUE )
b1 <- svywatts( ~eqincome , des_eusilc_rep , type_thresh = "relm" , deff = TRUE )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , type_thresh = "relm" , deff = TRUE )
...
test_that("database svywatts",{
  ...
  # calculate estimates
  c1 <- svywatts( ~eqincome , dbd_eusilc , type_thresh = "relm" , deff = TRUE )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywatts , type_thresh = "relm" , deff = TRUE )
...
# calculate estimates
sub_des <- svywatts( ~eqincome , design = subset( des_eusilc , hsize == 1) , type_thresh = "relm" , deff = TRUE )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywatts , type_thresh = "relm" , deff = TRUE )
sub_rep <- svywatts( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , type_thresh = "relm" , deff = TRUE )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywatts , type_thresh = "relm" , deff = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywatts( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , type_thresh = "relm" , deff = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywatts , type_thresh = "relm" , deff = TRUE )
  sub_dbr <- svywatts( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , type_thresh = "relm" , deff = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywatts , type_thresh = "relm" , deff = TRUE )
