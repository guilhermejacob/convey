...
for ( this.g in c(0,1,2) )  {
  ...
  # calculate estimates
  a1 <- svyfgt( ~eqincome , des_eusilc , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  b1 <- svyfgt( ~eqincome , des_eusilc_rep , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  test_that("database svyfgt",{
    ...
    # calculate estimates
    c1 <- svyfgt( ~eqincome , dbd_eusilc , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
    c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  # calculate estimates
  sub_des <- svyfgt( ~eqincome , design = subset( des_eusilc , hsize == 1) , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  sub_rep <- svyfgt( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  test_that("dbi subsets equal non-dbi subsets",{
    ...
    # calculate estimates
    sub_dbd <- svyfgt( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
    sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
    sub_dbr <- svyfgt( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE )
    sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svyfgt , g = this.g , percent = .60 , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
