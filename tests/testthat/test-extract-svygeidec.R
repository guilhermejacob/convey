...
# return test context
context("gei decomposition output survey.design and svyrep.design")
...
# calculate estimates
a1 <- svygeidec( ~eqincome , des_eusilc , epsilon = .5 , subgroup = ~db040 )
...
test_that("database svygei",{
  ...
  # calculate estimates
  c1 <- svygeidec( ~eqincome , dbd_eusilc , epsilon = .5 , subgroup = ~db040 )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svygeidec , epsilon = .5 , subgroup = ~db040 )
...
# calculate estimates
sub_des <- svygeidec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , epsilon = .5 , subgroup = ~db040 )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svygeidec , epsilon = .5 , subgroup = ~db040 )
sub_rep <- svygeidec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , epsilon = .5 , subgroup = ~db040 )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svygeidec , epsilon = .5 , subgroup = ~db040 )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svygeidec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , epsilon = .5 , subgroup = ~db040 )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svygeidec , epsilon = .5 , subgroup = ~db040 )
  sub_dbr <- svygeidec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , epsilon = .5 , subgroup = ~db040 )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svygeidec , epsilon = .5 , subgroup = ~db040 )
