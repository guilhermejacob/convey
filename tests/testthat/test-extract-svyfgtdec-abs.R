...
# calculate estimates
a1 <- svyfgtdec( ~eqincome , des_eusilc , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
b1 <- svyfgtdec( ~eqincome , des_eusilc_rep , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
d1 <- svyfgt( ~eqincome , des_eusilc , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
d2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
e1 <- svyfgt( ~eqincome , des_eusilc , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
e2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
f1 <- svyfgt( ~eqincome , des_eusilc , g = 1 , abs_thresh = 7000 , type_thresh = "abs" )
f2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgt , g = 1 , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("database svyfgtdec",{
  ...
  # calculate estimates
  c1 <- svyfgtdec( ~eqincome , dbd_eusilc , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
...
# calculate estimates
sub_des <- svyfgtdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
sub_rep <- svyfgtdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
  sub_dbr <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyfgtdec , g = 2 , abs_thresh = 7000 , type_thresh = "abs" )
