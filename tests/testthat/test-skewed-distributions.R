...
# list of functions
all_funs <- c( "svyrmir" , "svyqsr" , "svyarpt" , "svyarpt" , "svyatk" , "svyfgt" , "svygini" , "svygpg" , "svyiqalpha" , "svyisq" , "svypoormed" , "svygei" , "svyrmpg" , "svylorenz" )
    ...
    for( this_function in all_funs ){
      ...
      for( this_prefix in c( 'unwtd' , 'binom' , 'unif' ) ){
        ...
        for( this_formula in list( ~ beta_050_050 , ~ beta_500_100 , ~ beta_100_300 , ~ beta_200_200 , ~ beta_200_500 , ~ pois5 , ~ pois500 ) ){
          ...
          if( any( unlist( lapply( list( svygei , svyatk ) , function( z ) identical( z , FUN ) ) ) ) ){
