...
# return test context
context("fgt-relm output survey.design and svyrep.design")
...
test_that("svyfgt works on unweighted designs", {
  svyfgt( ~api00, design=dstrat1 , g = 0 , percent = 0.6 , type_thresh = "relm" )
} )
...
# calculate estimates
a1 <- svyfgt( ~eqincome , des_eusilc , g = 0 , percent = 0.6 , type_thresh = "relm" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
b1 <- svyfgt( ~eqincome , des_eusilc_rep , g = 0 , percent = 0.6 , type_thresh = "relm" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
...
test_that("database svyfgt",{
  ...
  # calculate estimates
  c1 <- svyfgt( ~eqincome , dbd_eusilc , g = 0 , percent = 0.6 , type_thresh = "relm" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
...
# calculate estimates
sub_des <- svyfgt( ~eqincome , design = subset( des_eusilc , hsize == 1) , g = 0 , percent = 0.6 , type_thresh = "relm" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
sub_rep <- svyfgt( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , g = 0 , percent = 0.6 , type_thresh = "relm" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgt( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , g = 0 , percent = 0.6 , type_thresh = "relm" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
  sub_dbr <- svyfgt( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , g = 0 , percent = 0.6 , type_thresh = "relm" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svyfgt , g = 0 , percent = 0.6 , type_thresh = "relm" )
