...
# return test context
context("fgt-relm decomposition output survey.design and svyrep.design")
...
# calculate estimates
a1 <- svyfgtdec( ~eqincome , des_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
a2 <- svyby( ~eqincome , ~rb090, des_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
b1 <- svyfgtdec( ~eqincome , des_eusilc_rep , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
b2 <- svyby( ~eqincome , ~rb090, des_eusilc_rep , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
...
test_that("database svyfgt",{
  ...
  # calculate estimates
  c1 <- svyfgtdec( ~eqincome , dbd_eusilc , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
  c2 <- svyby( ~eqincome , ~rb090, dbd_eusilc , svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
...
# calculate estimates
sub_des <- svyfgtdec( ~eqincome , design = subset( des_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
sby_des <- svyby( ~eqincome, by = ~rb090, design = des_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
sub_rep <- svyfgtdec( ~eqincome , design = subset( des_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
sby_rep <- svyby( ~eqincome, by = ~rb090, design = des_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
  sby_dbd <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
  sub_dbr <- svyfgtdec( ~eqincome , design = subset( dbd_eusilc_rep , rb090 == "male" ) , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
  sby_dbr <- svyby( ~eqincome, by = ~rb090, design = dbd_eusilc_rep, FUN = svyfgtdec , g = 2 , percent = 0.6 , type_thresh = "relm" , subgroup = ~db040 )
