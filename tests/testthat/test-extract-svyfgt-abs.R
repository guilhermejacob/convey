...
# return test context
context("fgt-abs output survey.design and svyrep.design")
...
test_that("svyfgt works on unweighted designs", {
  svyfgt( ~api00, design=dstrat1 , g = 0 , abs_thresh = 600 , type_thresh = "abs" )
} )
...
# calculate estimates
a1 <- svyfgt( ~eqincome , des_eusilc , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
b1 <- svyfgt( ~eqincome , des_eusilc_rep , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("database svyfgt",{
  ...
  # calculate estimates
  c1 <- svyfgt( ~eqincome , dbd_eusilc , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
...
# calculate estimates
sub_des <- svyfgt( ~eqincome , design = subset( des_eusilc , hsize == 1) , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
sub_rep <- svyfgt( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyfgt( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
  sub_dbr <- svyfgt( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svyfgt , g = 0 , abs_thresh = 7000 , type_thresh = "abs" )
