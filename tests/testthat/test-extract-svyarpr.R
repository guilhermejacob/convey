...
# calculate estimates
a1 <- svyarpr( ~eqincome , des_eusilc , deff = TRUE , influence = TRUE )
...
test_that( "output svyarpr" , {
  ...
  expect_equal( attr( a1 , "influence" ) , attr( d1 , "influence" ) )
  expect_equal( attr( b1 , "influence" ) , attr( e1 , "influence" ) )
} )
