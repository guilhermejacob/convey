...
test_that( "svywatts works on unweighted designs" , {
  expect_false( is.na ( coef( svywatts( ~api00, design=dstrat1 , type_thresh = "relm" ) ) ) )
  expect_false( is.na ( SE( svywatts( ~api00, design=dstrat1 , type_thresh = "relm" ) ) ) )
} )
...
# calculate estimates
a1 <- svywatts( ~eqincome , des_eusilc , type_thresh = "relm" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , type_thresh = "relm" )
b1 <- svywatts( ~eqincome , des_eusilc_rep , type_thresh = "relm" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , type_thresh = "relm" )
...
test_that("database svywatts",{
  ...
  # calculate estimates
  c1 <- svywatts( ~eqincome , dbd_eusilc , type_thresh = "relm" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywatts , type_thresh = "relm" )
...
# calculate estimates
sub_des <- svywatts( ~eqincome , design = subset( des_eusilc , hsize == 1) , type_thresh = "relm" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywatts , type_thresh = "relm" )
sub_rep <- svywatts( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , type_thresh = "relm" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywatts , type_thresh = "relm" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywatts( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , type_thresh = "relm" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywatts , type_thresh = "relm" )
  sub_dbr <- svywatts( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , type_thresh = "relm" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywatts , type_thresh = "relm" )
