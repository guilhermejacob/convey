...
# return test context
context( "watts-relq output survey.design and svyrep.design" )
...
# calculate estimates
a1 <- svywatts( ~eqincome , des_eusilc , type_thresh = "relq" , deff = TRUE , influence = TRUE )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
b1 <- svywatts( ~eqincome , des_eusilc_rep , type_thresh = "relq" , deff = TRUE , influence = TRUE )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
test_that("database svywatts",{
  ...
  # calculate estimates
  c1 <- svywatts( ~eqincome , dbd_eusilc , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
# calculate estimates
sub_des <- svywatts( ~eqincome , design = subset( des_eusilc , hsize == 1) , type_thresh = "relq" , deff = TRUE , influence = TRUE )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
sub_rep <- svywatts( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , type_thresh = "relq" , deff = TRUE , influence = TRUE )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywatts( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
  sub_dbr <- svywatts( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , type_thresh = "relq" , deff = TRUE , influence = TRUE )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywatts , type_thresh = "relq" , deff = TRUE , influence = TRUE , covmat = TRUE )
