...
for ( this.threshold in c( "abs", "relq","relm") ) for ( this.g in c(.5,2,3) )  {
  ...
  # return test context
  context( paste0( "rich-" , this.threshold ," Cha g=", this.g , " output survey.design and svyrep.design" ) )
  ...
  # calculate estimates
  a1 <- svyrich( ~eqincome , des_eusilc , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
  a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
  b1 <- svyrich( ~eqincome , des_eusilc_rep , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
  b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  test_that("database svyrich",{
    ...
    # calculate estimates
    c1 <- svyrich( ~eqincome , dbd_eusilc , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
    c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  # calculate estimates
  sub_des <- svyrich( ~eqincome , design = subset( des_eusilc , hsize == 1) , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
  sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
  sub_rep <- svyrich( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
  sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
  ...
  test_that("dbi subsets equal non-dbi subsets",{
    ...
    # calculate estimates
    sub_dbd <- svyrich( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
    sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
    sub_dbr <- svyrich( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE )
    sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svyrich , g = this.g , abs_thresh = 20000 , type_thresh = this.threshold , type_measure = "Cha" , deff = TRUE , influence = TRUE , covmat = TRUE )
