...
# return test context
context( "watts-abs output survey.design and svyrep.design" )
...
# calculate estimates
a1 <- svywatts( ~eqincome , des_eusilc , abs_thresh = 7000 , type_thresh = "abs" )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc , svywatts , abs_thresh = 7000 , type_thresh = "abs" )
b1 <- svywatts( ~eqincome , des_eusilc_rep , abs_thresh = 7000 , type_thresh = "abs" )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep , svywatts , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("database svywatts",{
  ...
  # calculate estimates
  c1 <- svywatts( ~eqincome , dbd_eusilc , abs_thresh = 7000 , type_thresh = "abs" )
  c2 <- svyby( ~eqincome , ~hsize, dbd_eusilc , svywatts , abs_thresh = 7000 , type_thresh = "abs" )
...
# calculate estimates
sub_des <- svywatts( ~eqincome , design = subset( des_eusilc , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svywatts , abs_thresh = 7000 , type_thresh = "abs" )
sub_rep <- svywatts( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svywatts , abs_thresh = 7000 , type_thresh = "abs" )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svywatts( ~eqincome , design = subset( dbd_eusilc , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc, FUN = svywatts , abs_thresh = 7000 , type_thresh = "abs" )
  sub_dbr <- svywatts( ~eqincome , design = subset( dbd_eusilc_rep , hsize == 1) , abs_thresh = 7000 , type_thresh = "abs" )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = dbd_eusilc_rep, FUN = svywatts , abs_thresh = 7000 , type_thresh = "abs" )
