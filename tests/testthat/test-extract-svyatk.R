...
test_that( "error on income <= 0 " , expect_error( svyatk( ~eqincome , des_eusilc , epsilon = .5 )  ) )
...
# calculate estimates
a1 <- svyatk( ~eqincome , des_eusilc , epsilon = .5 )
a2 <- svyby( ~eqincome , ~hsize, des_eusilc, svyatk , epsilon =.5 )
b1 <- svyatk( ~eqincome , des_eusilc_rep , epsilon = .5 )
b2 <- svyby( ~eqincome , ~hsize, des_eusilc_rep, svyatk , epsilon = .5 )
...
test_that("database svyatk",{
  ...
  # calculate estimates
  c1 <- svyatk( ~ eqincome , dbd_eusilc , epsilon = .5 )
  c2 <- svyby( ~ eqincome , ~hsize , dbd_eusilc , FUN = svyatk , epsilon = .5 )
...
# calculate estimates
sub_des <- svyatk( ~eqincome , design = subset( des_eusilc , hsize == 1) , epsilon = .5 )
sby_des <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyatk , epsilon = .5 )
sub_rep <- svyatk( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , epsilon = .5 )
sby_rep <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyatk , epsilon = .5 )
...
test_that("dbi subsets equal non-dbi subsets",{
  ...
  # calculate estimates
  sub_dbd <- svyatk( ~eqincome , design = subset( des_eusilc , hsize == 1) , epsilon = .5 )
  sby_dbd <- svyby( ~eqincome, by = ~hsize, design = des_eusilc, FUN = svyatk , epsilon = .5 )
  sub_dbr <- svyatk( ~eqincome , design = subset( des_eusilc_rep , hsize == 1) , epsilon = .5 )
  sby_dbr <- svyby( ~eqincome, by = ~hsize, design = des_eusilc_rep, FUN = svyatk , epsilon = .5 )
